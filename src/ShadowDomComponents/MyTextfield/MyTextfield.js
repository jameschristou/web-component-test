...
class MyTextfield extends HTMLElement {
  constructor() {
    ...
    <div class="editableTextfieldContainer">
      <div id="textdiv" class="editableTextfield" contentEditable="true">
      </div>
      <div id="actionsdiv" class="editableTextfieldActionsContainer hidden">
        <div class="editableTextfieldActions">
          <button id="saveBtn" class="editableTextfieldAction">
          ...
          <button id="cancelBtn" class="editableTextfieldAction">
            <svg width="24" height="24" viewBox="1 -2 24 24" focusable="false" role="presentation">
    ...
    this._textdiv = this.shadowRoot.getElementById('textdiv');
    ...
    this._saveBtn.onclick =
      e => {
        ...
        this._textslot.assignedNodes()[0].textContent = this._textdiv.innerText;
